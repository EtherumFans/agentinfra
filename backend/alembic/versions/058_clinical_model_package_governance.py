...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("redistribution_authorized", sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column("cloud_use_authorized", sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column("hospital_use_authorized", sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column("independent_gold_validated", sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column("independent_reviewer_approved", sa.Boolean(), server_default=sa.false(), nullable=False),
