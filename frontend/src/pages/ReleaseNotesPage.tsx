    ...
    <div className="flex h-full bg-muted/20">
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto p-8">
          <div className="mb-10">
            <h1 className="text-2xl font-bold text-foreground mb-2">Release Notes</h1>
            <p className="text-sm text-muted-foreground">iCoDer 医疗 AI 智能体平台版本变更记录。</p>
          </div>

          <div className="space-y-6">
            {RELEASES.map(release => (
              <div key={release.version} className="bg-background rounded-xl shadow-sm ring-1 ring-border/20 overflow-hidden">
                <button
          ...
          <div className="mt-10 border-t border-border pt-6 text-xs text-muted-foreground">
            <p>查看 <a href={`${BACKEND_BASE_URL}/docs`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">API 变更策略</a>。</p>
          </div>
        </div>
      </div>
    </div>
