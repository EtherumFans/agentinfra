...
| evidence_extractor | uncertain_low_confidence_requires_review_prompt | 0 | non_empty | no | yes |
| evidence_extractor | uncertain_risk_strength_requires_review_prompt | 0 | non_empty | no | yes |
...
| procedure-extractor | nonbillable_procedure_requires_status_evidence | 0 | in | no | yes |
| procedure-extractor | nonbillable_procedure_requires_status_evidence | 1 | non_empty | no | yes |
