...
Generated: `2026-08-22T23:00:22.852470+00:00`
...
- Visible dependent on an external LLM: 23
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 2
- Visible with an offline local baseline: 3
- Offline safe-fail-closed expected: 23
