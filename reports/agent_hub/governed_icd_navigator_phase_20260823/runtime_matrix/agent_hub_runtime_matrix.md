...
Generated: `2026-08-22T23:39:12.429012+00:00`
...
- Visible dependent on an external LLM: 22
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 3
- Visible with an offline local baseline: 4
- Offline safe-fail-closed expected: 22
