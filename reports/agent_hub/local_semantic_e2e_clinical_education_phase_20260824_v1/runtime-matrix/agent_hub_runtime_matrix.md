...
Generated: `2026-08-24T11:17:10.396470+00:00`
...
- Visible dependent on an external LLM: 6
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 19
- Visible with an offline local baseline: 20
- Offline safe-fail-closed expected: 6
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited twenty-Agent scope): 20
