...
Generated: `2026-08-24T12:36:33.843894+00:00`
...
- Visible dependent on an external LLM: 5
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 20
- Visible with an offline local baseline: 21
- Offline safe-fail-closed expected: 5
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited twenty-Agent scope): 21
