...
Generated: `2026-08-24T10:31:02.293307+00:00`
...
- Visible dependent on an external LLM: 7
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 18
- Visible with an offline local baseline: 19
- Offline safe-fail-closed expected: 7
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited nineteen-Agent scope): 19
