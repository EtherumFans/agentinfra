...
Generated: `2026-08-23T23:22:10.278794+00:00`
...
- Visible dependent on an external LLM: 17
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 8
- Visible with an offline local baseline: 9
- Offline safe-fail-closed expected: 17
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited nine-Agent scope): 9
