...
Generated: `2026-08-24T04:00:07.739009+00:00`
...
- Visible dependent on an external LLM: 12
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 13
- Visible with an offline local baseline: 14
- Offline safe-fail-closed expected: 12
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited fourteen-Agent scope): 14
