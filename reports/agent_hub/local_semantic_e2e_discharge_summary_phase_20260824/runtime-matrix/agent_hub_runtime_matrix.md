...
Generated: `2026-08-24T04:57:50.230624+00:00`
...
- Visible dependent on an external LLM: 11
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 14
- Visible with an offline local baseline: 15
- Offline safe-fail-closed expected: 11
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited fourteen-Agent scope): 15
