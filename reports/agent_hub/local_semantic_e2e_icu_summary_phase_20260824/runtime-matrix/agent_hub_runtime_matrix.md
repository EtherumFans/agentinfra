...
Generated: `2026-08-24T03:13:24.977504+00:00`
...
- Visible dependent on an external LLM: 13
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 12
- Visible with an offline local baseline: 13
- Offline safe-fail-closed expected: 13
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited thirteen-Agent scope): 13
