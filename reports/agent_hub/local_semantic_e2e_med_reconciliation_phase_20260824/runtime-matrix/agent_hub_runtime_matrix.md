...
Generated: `2026-08-24T01:16:32.327011+00:00`
...
- Visible dependent on an external LLM: 15
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 10
- Visible with an offline local baseline: 11
- Offline safe-fail-closed expected: 15
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited eleven-Agent scope): 11
