...
Generated: `2026-08-24T02:12:43.934424+00:00`
...
- Visible dependent on an external LLM: 14
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 11
- Visible with an offline local baseline: 12
- Offline safe-fail-closed expected: 14
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited twelve-Agent scope): 12
