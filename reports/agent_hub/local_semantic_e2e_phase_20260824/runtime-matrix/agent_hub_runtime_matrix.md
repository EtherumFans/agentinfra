...
Generated: `2026-08-23T22:15:48.785816+00:00`
...
- Visible dependent on an external LLM: 19
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 6
- Visible with an offline local baseline: 7
- Offline safe-fail-closed expected: 19
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited seven-Agent scope): 7
...
| diagnosis-extractor | Hub | executable | provider_registry | icoder.llm-with-tools.v1 | safe_fail_closed_without_external_provider | pending | n/a or pending | yes |
...
| procedure-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | safe_fail_closed_without_external_provider | pending | n/a or pending | yes |
...
| rule-explainer | Hub | executable | provider_registry | icoder.llm-with-tools.v1 | safe_fail_closed_without_external_provider | pending | n/a or pending | yes |
