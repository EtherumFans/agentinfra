...
Generated: `2026-08-24T13:36:54.210347+00:00`
...
- Visible dependent on an external LLM: 4
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 21
- Visible with an offline local baseline: 22
- Offline safe-fail-closed expected: 4
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited twenty-Agent scope): 22
