...
Generated: `2026-08-24T07:22:30.420290+00:00`
...
- Visible dependent on an external LLM: 9
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 16
- Visible with an offline local baseline: 17
- Offline safe-fail-closed expected: 9
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited seventeen-Agent scope): 17
