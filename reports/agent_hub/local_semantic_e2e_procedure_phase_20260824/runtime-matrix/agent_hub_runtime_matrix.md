...
Generated: `2026-08-23T22:43:45.288644+00:00`
...
- Visible dependent on an external LLM: 18
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 7
- Visible with an offline local baseline: 8
- Offline safe-fail-closed expected: 18
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited eight-Agent scope): 8
