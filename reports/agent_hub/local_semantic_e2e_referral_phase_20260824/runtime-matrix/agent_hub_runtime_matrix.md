...
Generated: `2026-08-24T05:39:04.732294+00:00`
...
- Visible dependent on an external LLM: 10
- Visible with optional external-LLM enhancement: 1
- Visible with local-only execution: 15
- Visible with an offline local baseline: 16
- Offline safe-fail-closed expected: 10
- Semantic live E2E verified by a validated evidence bundle: 0
- Local-only semantic HTTP E2E verified (limited fourteen-Agent scope): 16
