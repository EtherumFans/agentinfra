...
| diagnosis-extractor | yes | no | reference_or_contract_failed |
...
| drg-analyzer | yes | no | reference_or_contract_failed |
| evidence-extractor | yes | no | reference_or_contract_failed |
...
| surgical-registry | yes | no | reference_or_contract_failed |
