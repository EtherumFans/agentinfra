...
Generated: `2026-08-22T20:03:59.689204+00:00`
...
- Visible dependent on an external LLM: 25
- Visible with local-only execution: 1
- Offline safe-fail-closed expected: 25
...
| code-validation-agent | Hub | executable | dedicated.code_validation_v2 | icoder.llm-with-tools.v1 | safe_fail_closed_without_external_provider | pending | yes |
...
| evidence-ranker | Hub | executable | provider_registry | icoder.pure-llm.v1 | safe_fail_closed_without_external_provider | pending | yes |
| evidence-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | safe_fail_closed_without_external_provider | pending | yes |
| icd10-navigator | Hub | executable | provider_registry | icoder.pure-llm.v1 | safe_fail_closed_without_external_provider | pending | yes |
...
| note-completeness-agent | Hub | executable | dedicated.note_completeness_mcp | icoder.pure-llm.v1 | safe_fail_closed_without_external_provider | pending | yes |
