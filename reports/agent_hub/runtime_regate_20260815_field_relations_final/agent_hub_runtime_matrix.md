...
Generated: `2026-08-15T00:27:32.319354+00:00`
...
- Declared cross-field relations: 11
...
| clinical-documentation-improvement-agent | Hub | executable | dedicated.cdi_a2a_handler | icoder.cdi-real-orchestrator.v1 | icoder/CDIAgentOutputV1/v3 | yes |
| clinical-education | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ClinicalEducationOutput/v3 | yes |
| clinical-guidelines | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ClinicalGuidelinesOutput/v3 | yes |
| code-validation-agent | Hub | executable | dedicated.code_validation_v2 | icoder.llm-with-tools.v1 | icoder/CodeValidationOutput/v4 | yes |
...
| medical-coding-agent | Hub | executable | dedicated.medical_coding_dispatcher | icoder.medical-coding-runtime.v2 | icoder/MedicalCodingAgentOutputV2/v3 | yes |
...
| principal-diagnosis-review | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/PrincipalDxReview/v4 | yes |
| prior-auth | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/PriorAuthorizationOutput/v2 | yes |
| procedure-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ProcedureCodingOutput/v4 | yes |
