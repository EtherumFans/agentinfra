...
Generated: `2026-08-15T00:48:54.412859+00:00`
...
- Declared cross-field relations: 27
...
| clinical-documentation-improvement-agent | Hub | executable | dedicated.cdi_a2a_handler | icoder.cdi-real-orchestrator.v1 | icoder/CDIAgentOutputV1/v4 | yes |
...
| code-validation-agent | Hub | executable | dedicated.code_validation_v2 | icoder.llm-with-tools.v1 | icoder/CodeValidationOutput/v5 | yes |
...
| diagnosis-extractor | Hub | executable | provider_registry | icoder.llm-with-tools.v1 | icoder/DiagnosisExtractionOutput/v4 | yes |
...
| evidence-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/CodedEvidence/v5 | yes |
...
| principal-diagnosis-review | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/PrincipalDxReview/v5 | yes |
| prior-auth | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/PriorAuthorizationOutput/v2 | yes |
| procedure-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ProcedureCodingOutput/v6 | yes |
