...
Generated: `2026-08-15T00:06:06.227227+00:00`
...
| claim-check | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ClaimCheckOutput/v2 | yes |
| clinical-documentation-improvement-agent | Hub | executable | dedicated.cdi_a2a_handler | icoder.cdi-real-orchestrator.v1 | icoder/CDIAgentOutputV1/v2 | yes |
| clinical-education | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ClinicalEducationOutput/v2 | yes |
| clinical-guidelines | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ClinicalGuidelinesOutput/v2 | yes |
| code-validation-agent | Hub | executable | dedicated.code_validation_v2 | icoder.llm-with-tools.v1 | icoder/CodeValidationOutput/v3 | yes |
...
| compliance-guardrail-agent | Hub | executable | dedicated.compliance_mcp | icoder.rule-engine.v1 | icoder/ComplianceGuardrailOutput/v2 | yes |
| denial-appeals | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/DenialAppealOutput/v2 | yes |
| diagnosis-extractor | Hub | executable | provider_registry | icoder.llm-with-tools.v1 | icoder/DiagnosisExtractionOutput/v3 | yes |
...
| drg-analyzer | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/DRGDIPRiskReview/v2 | yes |
| evidence-ranker | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/EvidenceRankerOutput/v2 | yes |
| evidence-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/CodedEvidence/v3 | yes |
...
| medical-coding-agent | Hub | executable | dedicated.medical_coding_dispatcher | icoder.medical-coding-runtime.v2 | icoder/MedicalCodingAgentOutputV2/v2 | yes |
...
| principal-diagnosis-review | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/PrincipalDxReview/v3 | yes |
| prior-auth | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/PriorAuthorizationOutput/v2 | yes |
| procedure-extractor | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ProcedureCodingOutput/v3 | yes |
| referral-gen | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/ReferralOutput/v2 | yes |
| rule-explainer | Hub | executable | provider_registry | icoder.llm-with-tools.v1 | icoder/RuleExplanationOutput/v2 | yes |
| surgical-registry | Hub | executable | provider_registry | icoder.pure-llm.v1 | icoder/SurgicalRegistryOutput/v2 | yes |
