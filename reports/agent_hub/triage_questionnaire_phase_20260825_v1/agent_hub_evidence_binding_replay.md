...
| drg-analyzer | drg_review_evidence_items_match_input | source_text_mismatch | yes | yes |
| drg-analyzer | drg_review_evidence_items_match_input | out_of_source_bounds | yes | yes |
...
| principal_diagnosis_review | principal_review_evidence_items_match_input | source_text_mismatch | yes | yes |
| principal_diagnosis_review | principal_review_evidence_items_match_input | out_of_source_bounds | yes | yes |
...
| principal_diagnosis_review | principal_selection_basis_matches_input | source_text_mismatch | yes | yes |
| principal_diagnosis_review | principal_selection_basis_matches_input | out_of_source_bounds | yes | yes |
...
| triage | triage_evidence_items_match_input | source_text_mismatch | yes | yes |
| triage | triage_evidence_items_match_input | out_of_source_bounds | yes | yes |
