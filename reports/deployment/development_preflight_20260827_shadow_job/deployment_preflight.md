...
Generated: `2026-08-27T14:54:54.850325+00:00`

Result: **PASS**

| Check | Result |
|---|---:|
| cn_code_catalog_assets_are_image_owned_integrity_checked_and_fail_closed | pass |
| ccl2026_local_dataset_is_source_bound_aggregate_only_and_egress_blocked | pass |
| ccl2026_local_prediction_evaluator_is_exact_aggregate_only_and_fail_closed | pass |
| ccl2026_local_deterministic_baseline_is_gold_blind_offline_and_transient | pass |
| ccl2026_local_supervised_oof_is_leakage_bounded_aggregate_only_and_offline | pass |
| clinical_model_packages_are_metadata_only_four_eyes_and_fail_closed | pass |
| clinical_model_artifact_supply_chain_is_signed_scanned_and_shadow_only | pass |
| clinical_model_shadow_observations_are_aggregate_fail_closed_and_auto_rollback | pass |
| clinical_model_shadow_jobs_are_idempotent_fenced_recoverable_and_aggregate_only | pass |
| ccl2026_local_model_readiness_audit_blocks_unsafe_native_and_embedding_only_stacks | pass |
...
| bilingual_coding_gold_review_is_blinded_dual_adjudicated_and_fail_closed | pass |
| agent_failure_envelopes_are_suppressed_and_measured_separately | pass |
| provider_failures_have_bounded_retry_diagnostics_without_raw_content | pass |
...
| agent_template_catalog_is_pack_mastered_and_clone_safe | pass |
| agent_definition_lifecycle_is_audited_fail_closed_and_ui_truthful | pass |
...
| dotnet_sdk_ci_tests_packs_and_compiles_all_supported_frameworks | pass |
...
- Clinical shadow evaluation jobs were exercised only against repository synthetic fixtures and a temporary test database. A durable production queue, real shadow traffic, multi-host load/chaos testing, regional metrics/alerts and hospital rollback drills remain external or later gates.
