...
Generated: `2026-08-25T05:00:11.013366+00:00`
...
- Streams transport/authentication/retention, cross-worker lease recovery, governed 16 kHz signed little-endian PCM up to eight declared channels, deterministic per-channel audio-health events, participant attribution, fast-init scheduling, bounded ordered keyterm forwarding, and prerecorded opt-in Chinese dictation punctuation were exercised locally; real ASR/fact quality, provider billing, diarization, keyterm accuracy, multichannel clinical quality, compressed-format audio events, and other PCM profiles remain external gates.
